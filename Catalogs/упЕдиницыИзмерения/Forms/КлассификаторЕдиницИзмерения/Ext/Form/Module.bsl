...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.упЕдиницыИзмерения.ПолучитьМакет("КлассификаторЕдиницИзмерения");
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	упЕдиницыИзмерения.Ссылка КАК Ссылка,
	|	упЕдиницыИзмерения.Код КАК Код
	|ИЗ
	|	Справочник.упЕдиницыИзмерения КАК упЕдиницыИзмерения";
...
Процедура ОбработатьРезультатыПодбораНаСервере()
	...
	|	Справочник.упЕдиницыИзмерения КАК упЕдиницыИзмерения
	|ГДЕ
	|	упЕдиницыИзмерения.Код В(&МассивКодов)";
	...
	Для каждого СтрокаДерева Из МассивВыбранныхСтрок Цикл
		...
		Иначе
			СправочникОбъект = Справочники.упЕдиницыИзмерения.СоздатьЭлемент();
		КонецЕсли;
