...
Процедура ИнициализироватьКомпоновщикОтбораИПравила(НастройкиФормы)
	...
	// @@@.16/11/25-16:58:32.<УП> https://partners.v8.1c.ru/forum/t/1550818/m/1550818
	Если упДополнительныеПараметры = "Координаты совпадают" Тогда
		ТаблицаПравил.ЗаполнитьЗначения(Неопределено, "Правило");
		Правило = ТаблицаПравил.Найти("Широта", "Реквизит");
		Если Правило <> Неопределено Тогда
			Если Правило.ВариантыСравнения.НайтиПоЗначению("Равно") <> Неопределено Тогда
				Правило.Правило = "Равно";
			КонецЕсли;
		КонецЕсли;
		Правило = ТаблицаПравил.Найти("Долгота", "Реквизит");
		Если Правило <> Неопределено Тогда
			Если Правило.ВариантыСравнения.НайтиПоЗначению("Равно") <> Неопределено Тогда
				Правило.Правило = "Равно";
			КонецЕсли;
