...
Функция МассивТиповПредметов() Экспорт
	...
	МассивТиповПредметов.Добавить("ДокументСсылка.упЗаявкаНаПеревозкуГруза");
	МассивТиповПредметов.Добавить("ДокументСсылка.упЗаявкаНаТС");
	МассивТиповПредметов.Добавить("ДокументСсылка.упКоммерческоеПредложение");
	МассивТиповПредметов.Добавить("ДокументСсылка.упПредложениеПеревозчика");
	МассивТиповПредметов.Добавить("ДокументСсылка.упРейс");	
...
//                                      ДобавитьЭлементМассиваОписанияВозможныхТиповКонтактов общего модуля ВзаимодействияКлиентСервер.
//
