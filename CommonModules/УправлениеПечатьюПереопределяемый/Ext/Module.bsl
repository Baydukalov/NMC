...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	Для Каждого МенеджерТипа Из Менеджеры Цикл
		Для Каждого МенеджерОбъекта Из МенеджерТипа Цикл
			Если упСервисныеФункции.МетодРеализован(МенеджерОбъекта, "ДобавитьКомандыПечати") Тогда
				СписокОбъектов.Добавить(МенеджерОбъекта);
			КонецЕсли; 
		КонецЦикла;
	КонецЦикла;
