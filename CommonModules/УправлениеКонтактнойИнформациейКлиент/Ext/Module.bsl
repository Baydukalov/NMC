...
// +++.18/05/11-16:03:15.<УП> ПобитовоеИ и ПобитовоеИли переименованы в бспПобитовоеИ и бспПобитовоеИли (появились аналогичные функции глобального контекста)
Функция бспПобитовоеИ(БинарныйМассив1, БинарныйМассив2)
	Результат = Новый Массив;
...
Функция бспПобитовоеИли(БинарныйМассив1, БинарныйМассив2)
	Результат = Новый Массив;
	Для Индекс = 0 По БинарныйМассив1.Количество()-1 Цикл
