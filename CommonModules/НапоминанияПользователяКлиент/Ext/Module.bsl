...
Функция ПолучитьТекущиеОповещения(ВремяБлижайшего = Неопределено) Экспорт
	...
	// @@@.16/11/25-14:16:23.<УП> https://partners.v8.1c.ru/forum/t/1550636/m/1550636
	// В фоновом задании на сервере создаются напоминания через механизм событий и они должны сразу проверяться на клиенте
