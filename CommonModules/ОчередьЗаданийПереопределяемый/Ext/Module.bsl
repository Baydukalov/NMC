...
Процедура ПриПолученииСпискаШаблонов(Шаблоны) Экспорт
	...
	// +++.17/03/20-09:57:53.<УП>
	Если Ложь Тогда // Для контекстной подсказки
	    Шаблоны = Новый Массив;
	КонецЕсли;
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упЗапуститьОбработкуПотоков.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упИнтеграцияССерверамиСбораДанных.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упОбработкаСобытий.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упПоискПроизошедшихСобытий.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упПроверкаВозникновенияСобытий.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упПроверкаРаботыФоновыхЗаданий.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упРасчетРасстояний.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упСборСтатистикиНахожденияВТочкахПартнеров.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упУдалениеНеактуальныхДанныхСпутниковогоМониторинга.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.упФормированиеПредупреждений.Имя);
	// ---.17/03/20-09:57:53.<УП>
