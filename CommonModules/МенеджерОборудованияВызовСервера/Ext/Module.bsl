...
Функция ВыполнитьПроверкуАктивностиСмены(ИдентификаторУстройства) Экспорт
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодключаемоеОборудование.ККТ")
		Или ОбщегоНазначения.ПодсистемаСуществует("ПодключаемоеОборудование.ФискальныеРегистраторы")
		Или ОбщегоНазначения.ПодсистемаСуществует("ПодключаемоеОборудование.ПринтерЧеков") Тогда
			МодульКассовыеСменыВызовСервера = ОбщегоНазначения.ОбщийМодуль("КассовыеСменыВызовСервера");
			Возврат МодульКассовыеСменыВызовСервера.ПоследняяСменаАктивна(ИдентификаторУстройства);
	Иначе
