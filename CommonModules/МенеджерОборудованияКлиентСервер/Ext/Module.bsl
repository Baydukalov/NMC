...
Функция ПараметрыОперацииФискализацииЧека() Экспорт;
	...
	ПараметрыЧека.Вставить("АдресРасчетов"      , Неопределено); // Адрес расчетов
	ПараметрыЧека.Вставить("МестоРасчетов"      , Неопределено); // Место расчетов
	...
	ПараметрыЧека.Вставить("ШаблонЧека", Неопределено);
	ПараметрыЧека.Вставить("КассаККМ", Неопределено);
	ПараметрыЧека.Вставить("НефискальныеДокументы" , Новый Массив()); // Массив нефискальных документов.
...
Функция ПараметрыФискальнойСтрокиЧека() Экспорт;
	...
	// Обязательные поля
	ПараметрыСтроки.Вставить("Наименование");    // Наименование предмета расчета
	...
	ПараметрыСтроки.Вставить("Сумма"       , 0); // Стоимость предмета расчета с учетом скидок и наценок
	ПараметрыСтроки.Вставить("НомерСекции" , 0); // Номер секции ФР (для совместимости)
	ПараметрыСтроки.Вставить("СтавкаНДС"   , 0); // Ставка НДС в %
	...
	ПараметрыСтроки.Вставить("НомерСтрокиТовара");    // Дополнительный параметр для обработки шаблона чека
...
Функция ПараметрыТекстовойСтрокиЧека(Текст = Неопределено) Экспорт;
	...
	ПараметрыСтроки.Вставить("ПереносСтроки", Ложь);
	ПараметрыСтроки.Вставить("Выравнивание" , "Лево"); // "Лево", "Право", "Центр".
	Возврат ПараметрыСтроки; 
...
Функция ПараметрыОперацииЧекаКоррекции() Экспорт;
	...
	ПараметрыЧека.Вставить("КодСистемыНалогообложения"); // Код системы налогообложения 
...
//
Функция ПолучитьНаименованиеСистемыНалогообложения(КодСистемыНалогообложения, Кратко = Ложь) Экспорт;
