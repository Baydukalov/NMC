...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.упКорректировкаОстатковМатериалов.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);
    ...
    упУправлениеЗапасами.ДобавитьСторнированиеОстатковМатериалов(ДополнительныеСвойства, Реквизиты, Отказ);	
