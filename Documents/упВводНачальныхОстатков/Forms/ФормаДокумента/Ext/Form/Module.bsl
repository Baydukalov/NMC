...
Процедура УстановитьВидимость()
	...
	Элементы.ГруппаАгрегаты.Видимость = Объект.ТипОперацииВводаНачальныхОстатков = ПредопределенноеЗначение("Перечисление.упТипыОперацийВводаНачальныхОстатков.ОстаткиАгрегатовНаСкладах");
	Элементы.ГруппаМатериалы.Видимость = Объект.ТипОперацииВводаНачальныхОстатков = ПредопределенноеЗначение("Перечисление.упТипыОперацийВводаНачальныхОстатков.ОстаткиМатериаловНаСкладах");
	Элементы.ГруппаДополнительноеОборудование.Видимость = Объект.ТипОперацииВводаНачальныхОстатков = ПредопределенноеЗначение("Перечисление.упТипыОперацийВводаНачальныхОстатков.ОстаткиОборудованияНаСкладах");
	Элементы.Валюта.Видимость =  Объект.ТипОперацииВводаНачальныхОстатков = ПредопределенноеЗначение("Перечисление.упТипыОперацийВводаНачальныхОстатков.ОстаткиМатериаловНаСкладах");
